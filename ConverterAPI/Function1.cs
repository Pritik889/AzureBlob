...
namespace ConverterAPI
{
    public static class Function1
    {
        ...
        static string connectionString = "DefaultEndpointsProtocol=https;AccountName=readfilepk;AccountKey=YTOhphkTaGQ+RrVNsL0iQk/+RPvZTwBqZzjVcWide3rhPfkUW5BhgY61+DDDGFSAWQRYTTRTDFD+hhK9GA==;EndpointSuffix=core.windows.net";
